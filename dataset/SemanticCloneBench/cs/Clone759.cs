...
*  Stack overflow Question #:1029740
*  Stack Overflow answer #:20220790
*  And Stack Overflow answer#:46880713
*/
...
public void Configure (IApplicationBuilder app) {
    ...
    app.UseStaticFiles (new StaticFileOptions () {FileProvider = new PhysicalFileProvider (Path.Combine (Directory.GetCurrentDirectory (), @"wwwroot", "images")), RequestPath = new PathString ("/MyImages"), ContentTypeProvider = provider});
