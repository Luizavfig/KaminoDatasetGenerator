...
*  Stack overflow Question #:14513028
*  Stack Overflow answer #:14513523
*  And Stack Overflow answer#:14513523
*/
IEnumerable < OpenXmlElement > ConvertString < T > (string input, char pattern) where T : OpenXmlElement, new () {
