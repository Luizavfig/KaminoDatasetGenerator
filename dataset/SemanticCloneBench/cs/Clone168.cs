...
*  Stack overflow Question #:23880369
*  Stack Overflow answer #:45818425
*  And Stack Overflow answer#:23880487
*/
...
public static void ReplaceTextInWordDoc (Object findMe, Object replaceMe, ApplicationClass app) {
    ...
    if (replaceMe.ToString ().Length < 256) {
        ...
        app.Application.Selection.Find.Execute (ref findMe, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing);
        app.Application.Selection.Text = (string) replaceMe;
    }
}
