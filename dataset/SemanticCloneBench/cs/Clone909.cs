...
*  Stack overflow Question #:1873402
*  Stack Overflow answer #:1890152
*  And Stack Overflow answer#:1890152
*/
...
static unsafe Int16 [] GetShorts (Int32 value) {
    ...
    fixed (byte * numRef = buffer) {
        * ((Int32 *) numRef) = value;
        ...
        return new Int16 [] {(Int16) ((numRef [0] << 8) | numRef [1]), (Int16) ((numRef [2] << 8) | numRef [3])};
    }}
