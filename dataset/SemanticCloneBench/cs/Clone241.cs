...
*  Stack overflow Question #:26493018
*  Stack Overflow answer #:26496399
*  And Stack Overflow answer#:26496399
*/
...
public static IList ToAnonymousList (this IQueryable source) {
    ...
    var returnList = (IList) typeof (List < >).MakeGenericType (source.ElementType).GetConstructor (Type.EmptyTypes).Invoke (null);
